...
+(function($) {
    ...
    */
    ...
    $('.excerpt header small').each(function() {
        $(this).tooltip({
            container: 'body',
            title: 'This article has ' + $(this).text() + 'Pictures'
        })
    })
    ...
    $('.article-tags a, .post-tags a').each(function() {
        $(this).tooltip({
            container: 'body',
            placement: 'bottom',
            title: 'View about ' + $(this).text() + ' article'
        })
    })
    ...
    $('.post-edit-link').tooltip({
        container: 'body',
        placement: 'right',
        title: 'Go to the backend to edit this article'
    })
        ...
        switch (type) {
            case 'like':
                ...
                if( !islogin ){
                    ...
                    if( lslike.indexOf(','+pid+',')!==-1 ) return alert('You have already liked!')
    ...
    var edit_mode = '0',
        txt1 = '<div class="comt-tip comt-loading">Submitting, please wait...</div>',
